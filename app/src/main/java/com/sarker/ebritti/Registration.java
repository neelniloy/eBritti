...
public class Registration extends AppCompatActivity {
    ...
    private TextInputEditText schoolName,schoolID, userEmail,userPhone, userPass;
    private TextInputLayout nameEditTextLayout,idEditTextLayout,phoneEditTextLayout, emailEditTextLayout, passEditTextLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolID = findViewById(R.id.et_school_id);
        ...
        idEditTextLayout = findViewById(R.id.editTextSchoolIDLayout);
        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sID = schoolID.getText().toString();
                String phone = userPhone.getText().toString();
                     ...
                     if (sname.isEmpty()) {
                         ...
                         idEditTextLayout.setError("*ID required");
    ...
    private void sendUserData() {
        ...
        current_user_db = FirebaseDatabase.getInstance().getReference().child("SchoolsData").child(user_id);
        ...
        String sID = schoolID.getText().toString();
        String phone = userPhone.getText().toString();
        String teacherID = user_id.substring(7,14);
        ...
        reg.put("schoolName", sname);
        reg.put("schoolID", sID);
        reg.put("teacherEmail", email);
        reg.put("teacherPhone", phone);
        reg.put("teacherID", teacherID);
        reg.put("teacherUID", user_id);
        reg.put("teacherMembershipTime",saveCurrentTime);
        reg.put("teacherMembershipDate",saveCurrentDate);
